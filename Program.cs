...
{
    // Використання колекції List<T> для зберігання об'єктів - вимога №1
    ...
    // Метод додавання рослини з використанням колекції List<T> - вимога №2
    static void AddPlant()
    {
        ...
        try
        {
            ...
            // Використання методу TryAddPlant з PlantCollection для додавання об'єкта - вимога №2
    ...
    // Метод пошуку рослин з використанням методів колекції List<T> - вимога №2
    static void FindPlant()
    {
        ...
        switch (choice)
        {
            case "1":
                ...
                // Використання методу FindPlantsByName з PlantCollection для пошуку - вимога №2
            ...
            case "2":
                ...
                // Використання методу FindPlantsByType з PlantCollection для пошуку - вимога №2
            ...
            case "3":
                ...
                // Використання методу FindPlantsByAgeCategory з PlantCollection для пошуку - вимога №2
    ...
    // Метод видалення рослин з використанням методів колекції List<T> - вимога №2

...
public class ProgramTests
{
    ...
    // Вимога №4 - тестування методу додавання рослини
    [TestMethod]
    ...
    // Вимога №4 - тестування методу додавання з перевищенням ліміту
    [TestMethod]
    ...
    // Вимога №4 - тестування методу видалення рослини
    [TestMethod]
    ...
    // Вимога №4, №6 - тестування некоректного введення (невалідний індекс)
    [TestMethod]
    ...
    // Вимога №4 - тестування пошуку рослин за назвою
    [TestMethod]
    ...
    // Вимога №4, №6 - тестування пошуку при відсутності результатів
    [TestMethod]
    ...
    // Вимога №4 - тестування отримання кількості рослин
    [TestMethod]
    ...
    // Вимога №4 - тестування підрахунку кількості рослин
    [TestMethod]
    ...
    // Вимога №4 - тестування очищення колекції
    [TestMethod]
    ...
    // Вимога №4 - тестування видалення всіх рослин за назвою
    [TestMethod]
    ...
    // Вимога №4 - тестування пошуку рослин за типом
    [TestMethod]
    ...
    // Вимога №4 - тестування пошуку рослин за категорією віку
    [TestMethod]
    ...
    // Вимога №5 - тест на ізоляцію стану між тестами
    [TestMethod]
